...
func main() {
	...
	// filtered := filterByUser(processes, "apb")
	// filtered := filterByCommand(processes, "/Applications/Obsidian.app/Contents/MacOS/Obsidian")
	filtered := filterByCommand(processes, "python test/sleep.py")
